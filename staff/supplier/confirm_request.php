            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive ps">
                    ...
                    <td>" . $row['quantity'] . "</td>
                    <td> <a href='confirm_request.php?fpid=$row[id]' class='btn btn-info'>complete<a>
                     </td>
                    </tbody>
                    ";
                      }
              ...
              <div class="card">
                ...
                if (isset($_GET['fpid'])) {
                  ...
                  $s_supplier=$_SESSION['username'];
                  $supplier = $mysqli->query("select * from supplier where email='$s_supplier'") or die($mysqli->error);
                  $frow = $supplier->fetch_array();
                  $sid = $frow['id'];
